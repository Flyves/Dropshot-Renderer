...
2) Run the `./src/main/python/AppMonitor/main.py` script in administrator. Make sure you are using the python installation that comes with the RLBot framework (should be python 3.7). 
